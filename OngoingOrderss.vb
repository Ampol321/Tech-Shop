...
Public Class OngoingOrderss
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TECH_FINALS.OngoingOrderss.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedOngoingOrderss
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As OngoingOrderss = New OngoingOrderss()
        rpt.Site = Me.Site
        Return rpt
    End Function
