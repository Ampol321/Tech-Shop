...
Public Class ReceivedOrderss
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TECH_FINALS.ReceivedOrderss.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReceivedOrderss
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReceivedOrderss = New ReceivedOrderss()
        rpt.Site = Me.Site
        Return rpt
    End Function
