...
Public Class OngoingOrdersvb
    Dim ongoing As New OngoingOrderss
    Private Sub OngoingOrdersvb_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        datatable.Clear()
        Try
            ...
            ongoing.SetDataSource(datatable)
            OngoingViewer.ReportSource = ongoing
            OngoingViewer.Refresh()
