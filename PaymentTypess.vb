...
Public Class PaymentTypess
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TECH_FINALS.PaymentTypess.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPaymentTypess
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PaymentTypess = New PaymentTypess()
        rpt.Site = Me.Site
        Return rpt
    End Function
